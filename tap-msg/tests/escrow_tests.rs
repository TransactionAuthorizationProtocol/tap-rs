...
use tap_msg::message::{Escrow, Capture, Party, Agent};
...
fn test_escrow_payment_guarantee_flow() {
    ...
    // Create agents
    let merchant_agent = Agent::new("did:web:merchant.example", "MerchantAgent", "did:web:merchant.example");
    let payment_processor = Agent::new("did:web:paymentprocessor.example", "EscrowAgent", "did:web:paymentprocessor.example");
    let customer_wallet = Agent::new("did:web:customer.wallet", "CustomerAgent", "did:eg:customer");
...
fn test_escrow_asset_swap_flow() {
    ...
    let swap_service = Agent::new("did:web:swap.service", "EscrowAgent", "did:web:swap.service");
    ...
    let alice_escrow = Escrow::new_with_asset(
        ...
        bob.clone(),
        "2025-06-25T00:00:00Z".to_string(),
        vec![alice_wallet.clone(), bob_wallet.clone(), swap_service.clone()],
...
fn test_escrow_fiat_currency() {
    ...
    let marketplace = Agent::new("did:web:marketplace.example", "MarketplaceAgent", "did:eg:seller");
...
fn test_escrow_serialization() {
    ...
    assert_eq!(json["asset"], "eip155:1/erc20:0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48");
...
fn test_capture_serialization() {
    ...
    assert_eq!(json["settlementAddress"], "eip155:1:0x742d35Cc6634C0532925a3b844Bc9e7595f1234");
