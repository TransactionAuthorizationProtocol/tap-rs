...
fn test_valid_transaction_proposal() {
    ...
    let proposal = TransactionProposalBody {
        ...
        sender: AccountId::from_str("ethereum:1:0x1234567890123456789012345678901234567890").unwrap(),
        recipient: AccountId::from_str("ethereum:1:0xabcdefabcdefabcdefabcdefabcdefabcdefabcd").unwrap(),
        asset: AssetId::from_str("ethereum:1/erc20:0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48").unwrap(),
...
fn test_invalid_sender_network() {
    ...
    let proposal = TransactionProposalBody {
        ...
        sender: AccountId::from_str("polygon:137:0x1234567890123456789012345678901234567890").unwrap(),
        recipient: AccountId::from_str("ethereum:1:0xabcdefabcdefabcdefabcdefabcdefabcdefabcd").unwrap(),
        asset: AssetId::from_str("ethereum:1/erc20:0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48").unwrap(),
        amount: "100.0".to_string(),
        memo: Some("Test transaction".to_string()),
...
fn test_invalid_recipient_network() {
    ...
    let proposal = TransactionProposalBody {
        ...
        recipient: AccountId::from_str("polygon:137:0xabcdefabcdefabcdefabcdefabcdefabcdefabcd").unwrap(),
        asset: AssetId::from_str("ethereum:1/erc20:0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48").unwrap(),
        amount: "100.0".to_string(),
        memo: Some("Test transaction".to_string()),
        tx_reference: None,
...
fn test_invalid_asset_network() {
    ...
    let proposal = TransactionProposalBody {
        ...
        asset: AssetId::from_str("polygon:137/erc20:0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48").unwrap(),
        amount: "100.0".to_string(),
        memo: Some("Test transaction".to_string()),
        tx_reference: None,
        metadata: Default::default(),
